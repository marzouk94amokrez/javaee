...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60" onload="myFunction()">
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="lauraMenu">
              <ul class="nav navbar-nav navbar-right navbar-border">
                ...
                <li><a href="#about">meteo</a></li>
                <li><a href="#portfolio">images</a></li>
                <li><a href="#testimonial">inscription</a></li>
          ...
          <div class="row">
            <div class="col-md-12 wow fadeIn delay-05s">
              <div class="banner-text">
                <h2>office <span>narionale</span> de</h2>
                <p>meteorologie <br> **algerie</p>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-left">
          <div class="about-text">
            <p>mmmmmmmmmmmmmmmmmmmmmmmmmmmet dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            <p>&nbsp;</p>
  ...
  <section id="testimonial" class="section-padding wow fadeInUp">
    <div class="container">
      <div class="row">
        <h2 class="title text-center">inscription <span class="deco">de nos obeservateur</span> !!! Rapide </h2>
        <div class="test-sec">
          <div class="col-sm-12">
            
            <form action="inscription" method="post" role="form" class="contactForm">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <input type="text" class="form-control" name="password" id="subject" placeholder=" confirmation de password" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
              <div class="validation"></div>
            </div>
             <div class="form-group">
              <input type="text" class="form-control" name="station" id="name" placeholder="wilaya" data-rule="minlen:4" data-msg="Please enter at least 4 chars of subject" />
              <div class="validation"></div>
            </div>
            

            <div class="text-center"><button type="submit" class="btn btn-primary btn-lg">inscrire</button></div>
          </form>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 col-md-push-2">
          <div id="sendmessage">Your requeste has been sent. Thank you!</div>
          ...
          <form action="" method="post" role="form" class="contactForm">
            ...
            <div class="text-center"><button type="submit" class="btn btn-primary btn-lg">acceder</button></div>
          </form>
        </div>
